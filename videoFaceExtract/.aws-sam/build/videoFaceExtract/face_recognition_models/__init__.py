...
def pose_predictor_model_location():
    return "/tmp/shape_predictor_68_face_landmarks.dat"  # Use the model donwloaded from S3
    #return resource_filename(__name__, "models/shape_predictor_68_face_landmarks.dat")

def pose_predictor_five_point_model_location():
    return "/tmp/shape_predictor_5_face_landmarks.dat"
    #return resource_filename(__name__, "models/shape_predictor_5_face_landmarks.dat")

def face_recognition_model_location():
    return "/tmp/dlib_face_recognition_resnet_model_v1.dat" # Use the model donwloaded from S3
    #return resource_filename(__name__, "models/dlib_face_recognition_resnet_model_v1.dat")

def cnn_face_detector_model_location():
    return "/tmp/mmod_human_face_detector.dat" # Use the model donwloaded from S3
